    ...
    <div className="min-h-screen bg-[#050507] text-slate-300 flex flex-col font-sans selection:bg-cyan-500/30 select-none md:select-text" id="app-wrapper">
      ...
      <header className="bg-[#08080c] border-b border-cyan-900/40 px-6 py-4 sticky top-0 z-50 shadow-lg shadow-black/40">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          {/* Sync status and Sync Key controller */}
          <div className="flex items-center space-x-3 shrink-0" id="auth-controls-hud">
            {isFirebaseActive ? (
              <div 
                ...
                title="Continuous Multi-Device Cloud Sync Enabled"
              >
                <div className="h-2 w-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)] animate-pulse"></div>
                <span className="font-bold tracking-wider">CLOUD SYNC</span>
              </div>
            ) : (
              <div 
            ...
            {authChecking ? (
              <div className="text-xs bg-[#0d0e14] border border-slate-800 px-3.5 py-1.5 rounded-lg text-slate-500 flex items-center space-x-1.5 font-mono">
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <span className="text-xs text-slate-355 font-semibold hidden md:inline truncate max-w-[100px] font-mono">
